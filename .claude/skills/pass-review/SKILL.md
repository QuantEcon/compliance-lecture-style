...
corpus *churn*. Stamped, a refresh only re-reviews what actually changed: 2026-05 → 2026-08 was
49 new lectures plus edits, which is single-digit agent-hours rather than thirty.
